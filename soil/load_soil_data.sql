...
load data inpath 'hdfs:/user/yjn214/rbda-proj/mapunit_no_header.txt' overwrite into table mapunit;
load data inpath 'hdfs:/user/yjn214/rbda-proj/component_no_header.txt' overwrite into table component;
load data inpath 'hdfs:/user/yjn214/rbda-proj/chorizon_no_header.txt' overwrite into table chorizon; 